...
miniCv: [
    ...
    projects: [
        {                                             
      id: 'restaurant-suite',                                                                                                                                                                                                                                                    
      title: "Restaurant Suite — POS, KDS, Delivery & Cloud CRM",                                                                                                                                                                                                   
      description: [                                                                                                                                                                                                                                                         
          "Architected and delivered an end-to-end restaurant operations suite that unifies point-of-sale, kitchen display, delivery management, back-office and cloud CRM into a single multi-tenant platform, currently powering a live hospitality operation in Poland from one cloud server, with multi-tenant architecture ready for the group's planned expansion.",                                                                                                                                                                    
          ...
          "Designed the runtime to operate on under 30 MB of RAM from a single Go binary, allowing the entire suite to ship and update as one artifact across every venue, terminal, kitchen and back-office machine.",                                                      
          ...
          "Developed an internal optimization layer that automates a wide range of operational decisions previously made manually by floor and kitchen staff, turning hours of daily judgment work into instant, data-driven outputs.",                                      
      ...
      impact: [                                                                                                                                                                                                                                                              
          ...
          "Validated under sustained load testing on a staging environment matching production 648 requests per second at 200 concurrent users on a mixed read and write workload, with zero failures across 20,000+ requests and p95 latency under 510 ms over the public network.",                                                                                                                                                                                                                            
          "Live production deployment with sustained 100% uptime over the operational period, processing real customer transactions daily with full fiscal compliance and zero data-loss incidents.",                                                                        
          "Operates at approximately 6,000x headroom over current production peak demand, giving the operator unrestricted growth capacity without any architectural change required.",                                                                                      
      ...
      tech: [                                                                                                                                                                                                                                                                
          ...
          "Operational Automation Engine", "Menu Intelligence Engine",                                                                                                                                                                                                       
